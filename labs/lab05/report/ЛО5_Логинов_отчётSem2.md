...
![Открытый Midnight Commander](/home/geloginov/Изображения/imgl5/imgl5_1.png){#fig:001 width=70%}


 Перехожу в каталог ~/work/arch-pc используя файловый менеджер mc рис. @fig:002).

![Перемещение между директориями](/home/geloginov/Изображения/imgl5/imgl5_2.png){#fig:002 width=70%}


 С помощью функциональной клавиши F7 создаю каталог lab05 (рис. @fig:003).

![Создание каталога](/home/geloginov/Изображения/imgl5/imgl5_3.png){#fig:003 width=70%}


 Перехожу в созданный каталог и прописываю команду touch lab5-1.asm в строке ввода, чтобы создать файл, в котором буду работать  (рис. @fig:004).

![Создание файла в новой директории](/home/geloginov/Изображения/imgl5/imgl5_4.png){#fig:004 width=70%}

## Структура программы на языке ассемблера NASM

 С помощью функциональной клавиши F4 открываю созданный файл для редактирования в редакторе mcedit (рис. @fig:005).

![Открытие файла для редактирования](/home/geloginov/Изображения/imgl5/imgl5_5.png){#fig:005 width=70%}


 Ввожу в файл код программы для запроса строки у пользователя (рис. @fig:006). Далее выхожу из файла (F10), сохраняя изменения (F2).

![Редактирование файла](/home/geloginov/Изображения/imgl5/imgl5_6.png){#fig:006 width=70%}
...
![Открытие файла для просмотра](/home/geloginov/Изображения/imgl5/imgl5_7.png){#fig:007 width=70%}
...
![Компиляция файла и передача на обработку компоновщику](/home/geloginov/Изображения/imgl5/imgl5_8.png){#fig:008 width=70%}


Запускаю исполняемый файл. Программа выводит строку "Введите строку: " и ожидает ввода с клавиатуры, я ввожу свои ФИО, на этом программа завершает свою работу (рис. @fig:009).

![Исполнение файла](/home/geloginov/Изображения/imgl5/imgl5_9.png){#fig:009 width=70%}

## Подключение внешнего файла

Скачиваю файл in_out.asm со страницы курса в ТУИС. Он сохранился в каталог "Загрузки" (рис. @fig:010).

![Скачанный файл отображается в файловом менеджере](/home/geloginov/Изображения/imgl5/imgl5_10.png){#fig:010 width=70%}


 С помощью функциональной клавиши F5 копирую файл in_out.asm из каталога Загрузки в созданный каталог lab05 (рис. @fig:011).

![Копирование файла](/home/geloginov/Изображения/imgl5/imgl5_11.png){#fig:011 width=70%}
...
![Копирование файла с изменением его имени](/home/geloginov/Изображения/imgl5/imgl5_12.png){#fig:012 width=70%}
...
![Редактирование файла](/home/geloginov/Изображения/imgl5/imgl5_13.png){ #fig:013 width=70% }
...
![Исполнение файла](/home/geloginov/Изображения/imgl5/imgl5_14.png){#fig:014 width=70%}


Открываю файл lab5-2.asm для редактирования в mcedit функциональной клавишей F4. Изменяю в нем подпрограмму sprintLF на sprint. (рис. @fig:015).

![Редактирование файла](/home/geloginov/Изображения/imgl5/imgl5_15.png){#fig:015 width=70%}


Снова транслирую файл, выполняю компоновку созданного объектного файла, запускаю новый исполняемый файл (рис. @fig:016).

![Исполнение файла](/home/geloginov/Изображения/imgl5/imgl5_16.png){#fig:016 width=70%}
...
![Копирование файла с изменением его имени](/home/geloginov/Изображения/imgl5/imgl5_17.png){#fig:017 width=70%}
...
![Редактирование файла](/home/geloginov/Изображения/imgl5/imgl5_18.png){#fig:018 width=70%}


2. Создаю объектный файл lab5-1-1.o, отдаю его на обработку компоновщику, получаю исполняемый файл lab5-1-1, запускаю полученный исполняемый файл. Программа запрашивает ввод, ввожу свои ФИО, далее программа выводит введенные мною данные(рис. @fig:019).

![Исполнение файла](/home/geloginov/Изображения/imgl5/imgl5_19.png){#fig:019 width=70%}
...
3. Создаю копию файла lab5-2.asm с именем lab5-2-1.asm с помощью функциональной клавиши F5(рис. @fig:020).

![Копирование файла](/home/geloginov/Изображения/imgl5/imgl5_20.png){#fig:020 width=70%}
...
![Редактирование файла](/home/geloginov/Изображения/imgl5/imgl5_21.png){#fig:021 width=70%}


4. Создаю объектный файл lab5-2-1.o, отдаю его на обработку компоновщику, получаю исполняемый файл lab5-2-1, запускаю полученный исполняемый файл. Программа запрашивает ввод без переноса на новую строку, ввожу свои ФИО, далее программа выводит введенные мною данные (рис. @fig:022).

![Копирование файла](/home/geloginov/Изображения/imgl5/imgl5_22.png){#fig:022 width=70%}
